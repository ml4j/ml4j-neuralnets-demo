    ...
    SerializationHelper helper = new SerializationHelper(
		...
		WeightsMatrix layer1Weights = new WeightsMatrixImpl(
				...
				new WeightsFormatImpl(
                        ...
                        Collections.singletonList(Dimension.OUTPUT_DEPTH), WeightsMatrixOrientation.ROWS_SPAN_OUTPUT_DIMENSIONS));
		...
		WeightsMatrix layer3Weights = new WeightsMatrixImpl(
				...
				new WeightsFormatImpl(Collections.singletonList(Dimension.INPUT_FEATURE), Collections.singletonList(Dimension.OUTPUT_FEATURE), WeightsMatrixOrientation.ROWS_SPAN_OUTPUT_DIMENSIONS));
		...
		WeightsMatrix layer4Weights = new WeightsMatrixImpl(
				...
				new WeightsFormatImpl(Collections.singletonList(Dimension.INPUT_FEATURE), Collections.singletonList(Dimension.OUTPUT_FEATURE),
